 ...
 * Created by neo on 5/27/2016.
 */
public abstract class SensorOrientationListener extends OrientationEventListener {
    ...
    public SensorOrientationListener(Context context, int rate) {
        super(context, rate);
        ctx = context;
    }
