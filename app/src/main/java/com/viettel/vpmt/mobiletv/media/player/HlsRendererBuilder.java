...
/**
 * A {@link MobiPlayer.RendererBuilder} for HLS.
 */
public class HlsRendererBuilder implements MobiPlayer.RendererBuilder {
  ...
  private static final class AsyncRendererBuilder implements ManifestCallback<HlsPlaylist> {
    ...
    public void onSingleManifest(HlsPlaylist manifest) {
      ...
      HlsSampleSource sampleSource = new HlsSampleSource(chunkSource, loadControl,
          MAIN_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player, MobiPlayer.TYPE_VIDEO);
      ...
      if (haveSubtitles) {
        ...
        HlsSampleSource textSampleSource = new HlsSampleSource(textChunkSource, loadControl,
            TEXT_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player, MobiPlayer.TYPE_TEXT);
      ...
      renderers[MobiPlayer.TYPE_METADATA] = id3Renderer;
