...
public class MediaCodecAudioTrackRenderer extends MediaCodecTrackRenderer implements MediaClock {
    ...
    public interface EventListener extends MediaCodecTrackRenderer.EventListener {
         ...
         * @param bufferSizeMs           The size of the {@link AudioTrack}'s buffer, in
         *                               milliseconds, if it is
         *                               configured for PCM output. -1 if it is configured for
         *                               passthrough output, as the buffered
         *                               media can have a variable bitrate so the duration may be
         *                               unknown.
     ...
     * underlying {@link android.media.AudioTrack}. The message object should not be modified by
     * the
     ...
     *                                    For example a media file may start with a short clear
     *                                    region so as to allow playback to
     *                                    begin in parallel with key acquisition. This parameter
     *                                    specifies whether the renderer is
     *                                    permitted to play clear regions of encrypted media files
     *                                    before {@code drmSessionManager}
     *                                    has obtained the keys necessary to decrypt encrypted
     ...
     * @param eventListener               A listener of events. May be null if delivery of events is
     *                                    not required.
     * @param audioCapabilities           The audio capabilities for playback on this device. May be
     *                                    null if the
     *                                    default capabilities (no encoded audio passthrough
     ...
     * This implementation returns true if the {@link AudioTrack}'s audio capabilities indicate
     * that
